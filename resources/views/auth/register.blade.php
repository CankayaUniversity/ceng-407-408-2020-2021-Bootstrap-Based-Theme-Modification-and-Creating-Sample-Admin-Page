  ...
  <div class="auth-inner my-2">
    ...
    <div class="card mb-0">
      <div class="card-body p-4">
        ...
        <form class="auth-login-form mt-2" action="{{ route('register') }}" method="POST" novalidate="novalidate" data-bitwarden-watching="1">
        @csrf  
        <div class="mb-1">
            <label for="login-email" class="form-label">Name</label>
            <input type="text" class="form-control @error('email') is-invalid @enderror" id="login-name" name="name" placeholder="" aria-describedby="login-name" tabindex="1" autofocus="" control-id="ControlID-1" value="{{ old('name') }}">
            @error('name')
        ...
        <div class="mb-1">
          ...
          <div class="mb-1">
            ...
            <div class="input-group input-group-merge form-password-toggle">
              <input type="password" class="form-control form-control-merge @error('password') is-invalid @enderror" id="login-password" name="password_confirmation" tabindex="2" placeholder="············" aria-describedby="login-password" control-id="ControlID-2">
              <span class="input-group-text cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg></span>
              @error('password')
                  <span class="invalid-feedback" role="alert">
                      <strong>{{ $message }}</strong>
          ...
          <button class="btn btn-primary w-100 waves-effect waves-float waves-light" tabindex="4" control-id="ControlID-4">Sign up</button>
        </form>
